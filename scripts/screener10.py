#!/usr/bin/env python3
"""10MA R1 screener: the 20MA R3 pipeline with the page MAs switched to the
user's 10MA spec — PAGE 2 uses the 5-day MA over a 5-trading-day window;
PAGES 3/4/5 use the 10-day MA over 10 / 21 / 42-trading-day windows.
Bottoms, higher-lows, VCP, and the 7 certainty metrics are unchanged from R3.
...
json.dump(out, open(f"{SCRATCH}/screen_results10.json", "w"), ensure_ascii=False)
